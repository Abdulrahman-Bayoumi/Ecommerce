...
$id = $_GET['id'];
$select_detail = "SELECT * FROM blogs WHERE id = $id";
$result_detail = $conn->query($select_detail);
$key_detail = $result_detail->fetch_assoc();

$select_cat = "SELECT name FROM category_blog WHERE id = $id";
                ...
                <div class="col-lg-12">
                    <div class="blog-details-inner">
                        <div class="blog-detail-title">
                            <h2><?php echo $key_detail['address']; ?></h2>
                            <p><?php echo $key_cat['name']; ?> <span>-<?php echo $key_detail['u_data']; ?></span></p>
                        </div>
                        <div class="blog-large-pic">
                            <img src="images/<?php echo $key_detail['image']; ?>" alt="">
                        </div>
                        <div class="blog-detail-desc">
                            <p><?php echo $key_detail['dateils']; ?>
                            </p>
                        </div>
